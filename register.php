...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
        ...
        <button type="button" class="btn btn-info mr-2" onclick="generarPDF('reporte inventario mueble')"> 
      ...
      <form class="d-none d-sm-inline-block form-inline ml-auto mr-0 my-2 my-md-0 mw-100 navbar-search" method="GET" action="register.php">
    ...
    <div class="card-body">
      ...
      <?php
        ...
        if(isset($_GET['search_query']) && !empty($_GET['search_query'])) {
            ...
            $query .= " WHERE `id` LIKE '%$search%' OR `unidad administrativa` LIKE '%$search%' OR `codigo interno del bien` LIKE '%$search%' OR `descripcion` LIKE '%$search%' OR `marca` LIKE '%$search%' OR `modelo` LIKE '%$search%' OR `categoria general` LIKE '%$search%' OR `estado del uso del bien` LIKE '%$search%'";
        }
      ...
      <td>
          <?php 
              if (!empty($row['fecha_edicion'])) {
                  // Asegúrate que es 'h' minúscula y 'A' mayúscula
